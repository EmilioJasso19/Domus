...
export class Init1780542719176 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."days_enum" AS ENUM('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday')`);
        await queryRunner.query(`CREATE TABLE "blocked_schedules" ("id" BIGSERIAL NOT NULL, "user_id" bigint NOT NULL, "home_id" bigint NOT NULL, "day" "public"."days_enum" NOT NULL, "start_time" TIME NOT NULL, "end_time" TIME NOT NULL, "start_date" date, "end_date" date, CONSTRAINT "uq_blocked_schedule" UNIQUE ("user_id", "home_id", "day", "start_time"), CONSTRAINT "PK_c261c233bf026a2fe5887231601" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "blocked_schedules" ADD CONSTRAINT "FK_c55a68f769a5969ecc5ae5bc387" FOREIGN KEY ("user_id", "home_id") REFERENCES "user_home_roles"("user_id","home_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "blocked_schedules" DROP CONSTRAINT "FK_c55a68f769a5969ecc5ae5bc387"`);
