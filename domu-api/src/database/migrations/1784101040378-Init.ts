...
export class Init1784101040378 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "reminders" ("id" BIGSERIAL NOT NULL, "date_time" TIMESTAMP WITH TIME ZONE NOT NULL, "reminder_sent" boolean NOT NULL DEFAULT false, "occurrence_id" bigint NOT NULL, CONSTRAINT "PK_38715fec7f634b72c6cf7ea4893" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TYPE "public"."frequency_type_enum" RENAME TO "frequency_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."frequency_type_enum" AS ENUM('once', 'daily', 'weekly', 'monthly')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."frequency_type_enum_old" AS ENUM('once', 'daily', 'weekly', 'monthly', 'custom')`);
